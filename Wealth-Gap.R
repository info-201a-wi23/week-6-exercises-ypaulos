...
ggplot(data = total_avg_wealth) + geom_point(aes(x = year, y = avg_wealth)) + geom_line(aes(x = year, y = avg_wealth))
...
ggplot(data = avg_race_wealth) + geom_point(aes(x = year, y = wealth_family, color = race)) + geom_line(aes(x = year, y = wealth_family, color = race))
